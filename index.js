...
ws.onerror = () => { sendTG(chat, "📡 Deriv connection error."); }; if(autoTrading) setTimeout(()=>startTrader(chat),5000); }; ws.onclose=()=>{ if(autoTrading) setTimeout(()=>startTrader(chat),5000); }; }
